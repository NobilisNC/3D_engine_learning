	...
	namespace sys
	{
		namespace 
		{
			...
			void InitializeMappingTable(std::vector<MapEntry> &table)
			{
				...
				table.push_back(MapEntry("GL_ARB_multi_bind", &exts::var_ARB_multi_bind, _detail::Load_ARB_multi_bind));
				...
				table.push_back(MapEntry("GL_ARB_clip_control", &exts::var_ARB_clip_control, _detail::Load_ARB_clip_control));
				...
				table.push_back(MapEntry("GL_ARB_get_texture_sub_image", &exts::var_ARB_get_texture_sub_image, _detail::Load_ARB_get_texture_sub_image));
				table.push_back(MapEntry("GL_ARB_shader_texture_image_samples", &exts::var_ARB_shader_texture_image_samples));
				table.push_back(MapEntry("GL_ARB_texture_barrier", &exts::var_ARB_texture_barrier, _detail::Load_ARB_texture_barrier));
				...
				table.push_back(MapEntry("GL_KHR_robustness", &exts::var_KHR_robustness, _detail::Load_KHR_robustness));
			}
